...
int main() 
{
    ...
    headContact = new ContactNode(fullName, phoneNum, nextContact1);//First contact node (head of heap)
    ...
    // 
    nextContact1 = new ContactNode(fullName, phoneNum, nextContact2);
    headContact->InsertAfter(nextContact1);// Create a new contact here with "new" 
    ...
    // 
    nextContact2 = new ContactNode(fullName, phoneNum, NULL);
    nextContact1->InsertAfter(nextContact2);// Create a new contact here with "new" 
    // Use the insertAfter to conect the two nodes
    // ...
